				...
				<div className='about-card'>
					<div className='selfDesc'>
						...
						<div className='highlightsList'>
							<p>
								I provide online presence to companies and individuals looking
								to reach the right people in the best way possible.
							</p>
							<p>
								Web presence is the first point of contact your audience will
								have with you, and it's also the most essential. Without it, you
								cannot move forward.
							</p>
						...
						<div className='desc_Summary'>
							<div className='a-award'>
								...
								<div className='a-award-texts'>
									...
									<p className='a-award-desc'>
										<span className='category-desc'>Project</span>: Axis Bank
									</p>
								</div>
							</div>
							<div className='a-award'>
								...
								<div className='a-award-texts'>
									...
									<p className='a-award-desc'>
										<span className='category-desc'>Category</span>: Operational
										Excellence
									</p>
									<p className='a-award-desc'>
										<span className='category-desc'>Project</span>: IHS Markit
									</p>
								</div>
							</div>
						</div>
